            ...
            <Card style={{ height: 400, width: 210 }}>
              <CardContent>
                ...
                <Typography variant="body1">
                  Cada uno de nosotros estamos capacitados para resolver todas
                  tus dudas sobre tu alimento. Brindando herramientas para
          ...
          <Grid item xs={12} sm={6} md={2.3}>
            <Card style={{ height: 400, width: 210 }}>
              <CardContent>
                ...
                <Typography variant="body1">
                  Aceptamos todas las tarjetas de crédito en tres pagos sin
                  interés, débito y transferencias.
                </Typography>
              </CardContent>
            </Card>
          </Grid>
          ...
          <Grid item xs={12} sm={6} md={2.3}>
            <Card style={{ height: 400, width: 210 }}>
              <CardContent>
                ...
                <Typography style={{ fontSize: '1rem' }}>
                  <b>Envíos a domicilio</b>
                </Typography>
                <Typography variant="body1">
                  Los envíos a domicilio a partir de los $2000, para que nunca
                  le falte nada a tu mascota.
                </Typography>
              </CardContent>
            </Card>
          </Grid>
          ...
          <Grid item xs={12} sm={6} md={2.3}>
            <Card style={{ height: 400, width: 210 }}>
              <CardContent>
                ...
                <Typography variant="body1">
                  Nuestros productos tienen garantía de calidad asegurada.
                  Permitiendo la devolución dentro de los 5 días de realizada la
                  compra.
                </Typography>
              </CardContent>
            </Card>
          ...
          <Grid item xs={12} sm={6} md={2.3}>
            <Card style={{ height: 400, width: 210 }}>
              <CardContent style={{ alignItems: 'center' }}>
                ...
                <Typography style={{ fontSize: '1rem' }}>
                  <b>Nos interesa tu mascota</b>
                </Typography>
                <Typography variant="body1">
                  Podemos asesorarte sobre todo lo necesario para el bienestar
                  de tu mascota. Tenemos atención directa con los centros de
                  salud veterinarios de la zona.
                </Typography>
              </CardContent>
            </Card>
          </Grid>
